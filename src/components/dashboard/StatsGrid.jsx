...
const statCards = [
  ...
  { id: 'tasks', label: 'Taches a faire', icon: CheckSquare, key: 'pendingTasks', gradient: 'from-accentSec/30 to-accentSec/5' },
          ...
          <div key={card.id}
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[10px] md:text-[11px] font-mono" style={{ color: 'var(--color-muted)' }}>{card.label}</span>
              </div>
