      ...
      <div className="p-4 grid grid-cols-2 md:grid-cols-4 gap-3">
        {actions.map((a) => (
          <button key={a.id} onClick={() => setActiveSection(a.section)}
            className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-accent/5 hover:border-accent/30 transition-all duration-200 group gradient-border" style={{ background: 'var(--color-surface-solid)', border: '1px solid var(--color-border)' }}>
