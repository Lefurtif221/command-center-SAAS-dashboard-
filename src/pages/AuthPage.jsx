    ...
    <div className="min-h-screen bg-bg flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <button onClick={googleLogin} className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-surface border border-border rounded-lg text-text text-sm font-medium hover:border-accent/50 transition-colors mb-4">
