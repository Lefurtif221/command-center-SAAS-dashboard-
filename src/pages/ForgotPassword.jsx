      ...
      <div className="w-full max-w-md">
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} className="glass-strong noise rounded-2xl p-6 shadow-2xl">
            ...
            <button type="submit" disabled={loading} className="w-full bg-accent text-bg hover:bg-[#8dd8fc] font-semibold text-sm py-2.5 rounded-xl transition-all duration-200 disabled:opacity-50 shadow-[0_0_20px_-5px_rgba(125,211,252,0.3)] hover:shadow-[0_0_30px_-5px_rgba(125,211,252,0.4)]">
